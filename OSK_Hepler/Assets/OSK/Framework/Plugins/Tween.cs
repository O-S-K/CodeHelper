...
public class Tween : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (TimeUtils.SystemTimeInMilliseconds >= endTime)
        {
            switch (loopType)
            {
                case LoopType.None:
    ...
    {
        startTime = TimeUtils.SystemTimeInMilliseconds;
    ...
    {
        float lerpT = (float)(TimeUtils.SystemTimeInMilliseconds - startTime) / duration;
