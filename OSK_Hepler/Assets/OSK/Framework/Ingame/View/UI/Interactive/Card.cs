    ...
    IPointerExitHandler, IPointerUpHandler, IPointerDownHandler
{
    ...
    {
        Vector3 movement = (transform.position - Input.mousePosition);
         movementDelta = Vector3.Lerp(movementDelta, movement, 25 * Time.deltaTime);
        Vector3 movementRotation = /*(parentCard.isDragging ? movementDelta :*/ movement/*)*/ * 20;
        rotationDelta = Vector3.Lerp(rotationDelta, movementRotation, 20 * Time.deltaTime);
