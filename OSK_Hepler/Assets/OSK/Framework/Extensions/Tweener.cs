...
public class Tweener : MonoBehaviour {
    ...
    private TweenAction AddTween(Rigidbody2D obj, Vector3 target, TweenAction.Type type, float duration, float delay, TweenEasings.Easings ease = TweenEasings.Easings.Linear, int easeIndex = -1, bool removeOld = true)
    {
	    // remove old ones of same object
	    if (removeOld)
	    {
